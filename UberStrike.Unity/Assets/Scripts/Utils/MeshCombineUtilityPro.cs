...
public class MeshCombineUtilityPro
{
    ...
    public static Mesh Combine(MeshInstance[] combines, bool generateStrips, bool copyTangents, bool copyVertexColor, bool copyUV2, bool copyNormals)
    {
        int vertexCount = 0;
        int triangleCount = 0;
        int stripCount = 0;
        ...
        //Don't copy tangents if not selected
        if (copyTangents)
        {
            foreach (MeshInstance combine in combines)
            {
