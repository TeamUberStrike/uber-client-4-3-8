...
public static class Mathfx
{
    ...
    // Rotates a 2D point around a center by a number of degrees. Used by the rotated
    // on-screen D-pad / jump+crouch touch buttons. Ported from the mobile/webgl branch.
