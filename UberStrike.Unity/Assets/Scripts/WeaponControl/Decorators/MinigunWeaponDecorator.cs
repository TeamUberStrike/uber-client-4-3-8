...
public class MinigunWeaponDecorator : BaseWeaponDecorator
{
    ...
    private float _maxWarmUpTime = 0;
    private float _maxWarmDownTime = 0;

    public float MaxWarmUpTime { get { return _maxWarmUpTime; } }
    public float MaxWarmDownTime { get { return _maxWarmDownTime; } }
    ...
    protected override void Awake()
    {
        ...
        if (_warmUpSound == null) throw new CmuneException("MinigunWeaponDecorator - _warmUpSound is NULL");
        if (_warmDownSound == null) throw new CmuneException("MinigunWeaponDecorator - _warmDownSound is NULL");
