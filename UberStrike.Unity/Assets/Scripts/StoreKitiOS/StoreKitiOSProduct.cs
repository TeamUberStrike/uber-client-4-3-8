...
public class StoreKitiOSProduct
{
	...
	public static List<StoreKitiOSProduct> productsFromJson( string json )
	{
		var productList = new List<StoreKitiOSProduct>();
    ...
    public static StoreKitiOSProduct productFromHashtable( Hashtable ht )
    {
        StoreKitiOSProduct product = new StoreKitiOSProduct();
